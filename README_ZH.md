...
<br/><br/>
<a title="Build Status" target="_blank" href="https://github.com/Marek-maxs/goroutine-pool/actions?query=workflow%3ATests"><img src="https://img.shields.io/github/workflow/status/panjf2000/ants/Tests?style=flat-square&logo=github-actions" /></a>
...
<a title="Release" target="_blank" href="https://github.com/Marek-maxs/goroutine-pool/releases"><img src="https://img.shields.io/github/v/release/panjf2000/ants.svg?color=161823&style=flat-square&logo=smartthings" /></a>
<a title="Tag" target="_blank" href="https://github.com/Marek-maxs/goroutine-pool/tags"><img src="https://img.shields.io/github/v/tag/panjf2000/ants?color=%23ff8936&logo=fitbit&style=flat-square" /></a>
<br/>
...
<a title="Go Report Card" target="_blank" href="https://goreportcard.com/report/github.com/Marek-maxs/goroutine-pool"><img src="https://goreportcard.com/badge/github.com/Marek-maxs/goroutine-pool?style=flat-square" /></a>
<a title="Doc for ants" target="_blank" href="https://pkg.go.dev/github.com/Marek-maxs/goroutine-pool/v2?tab=doc"><img src="https://img.shields.io/badge/go.dev-doc-007d9c?style=flat-square&logo=read-the-docs" /></a>
...
``` powershell
go get -u github.com/Marek-maxs/goroutine-pool
```

### 使用 `ants` v2 版本 (开启 GO111MODULE=on):

```powershell
go get -u github.com/Marek-maxs/goroutine-pool/v2
```
...
import (
	...
	"github.com/Marek-maxs/goroutine-pool/v2"
)
...
[![](https://opencollective.com/ants/contributors.svg?width=890&button=false)](https://github.com/Marek-maxs/goroutine-pool/graphs/contributors)
...
- [Repositories that depend on ants/v2](https://github.com/Marek-maxs/goroutine-pool/network/dependents?package_id=UGFja2FnZS0yMjY2ODgxMjg2)

- [Repositories that depend on ants/v1](https://github.com/Marek-maxs/goroutine-pool/network/dependents?package_id=UGFja2FnZS0yMjY0ODMzNjEw)
